...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (smex counsel swiper zenburn-theme typescript-mode solarized-theme scala-mode2 powerline magit idris-mode helm-swoop haskell-mode color-theme-sanityinc-solarized auctex ace-jump-mode)))
